		...
		<script type="text/javascript">
			...
			$(document).ready(function() {
				...
				$(document).on('click', '#chek', function() {
					...
					location.href="kosCartDelete.k?kcnumV="+kcnumV;
				});
				...
				$(document).on('click', '#shopingBtn', function() {
					alert(">>> shopingBtn :");
					location.href="kosProductSelectAll.lhd";
				});
				...
				<tbody>
					...
					<tr>
						...
						<td class="tt" align="center">		
							...
							<button type="button" class="delBtn" name="delsBtn" id="delsBtn" value=<%= _kcvo.getKcnum() %> >삭제</button><br>
						</td>	
					</tr>	
					<%
						} // end of for
