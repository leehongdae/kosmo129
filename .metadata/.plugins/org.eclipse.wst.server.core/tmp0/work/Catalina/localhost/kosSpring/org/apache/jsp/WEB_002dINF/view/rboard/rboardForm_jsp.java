 ...
 * Generated at: 2023-06-02 06:19:34 UTC
...
public final class rboardForm_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_imports_classes.add("a.b.c.com.kos.rboard.vo.KosRboardVO");
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("					console.log(\">>> insertBtn In\");\r\n");
      out.write("					\r\n");
      out.write("					let insertURL = \"rboardInsert.lhd\";\r\n");
      out.write("					let method = \"POST\";\r\n");
      out.write("					let dataParam = $(\"#rboardForm\").serialize();\r\n");
      ...
      out.write("						alert(\">>> e : \"+ e.reponseText);\r\n");
      out.write("					}\r\n");
      out.write("				});\r\n");
      out.write("				\r\n");
      out.write("				// 댓글 삭제\r\n");
      ...
      out.write("					\r\n");
      out.write("					var rbnumV = $(this).parents(\"li\").attr(\"dataNum\");\r\n");
      out.write("					alert(\">>> rbnumV : \" + rbnumV);\r\n");
      out.write("					var target = $(this).parents(\".rbmemoItem\");\r\n");
      out.write("					console.log(\">>> target : \"+ target);\r\n");
      out.write("					\r\n");
      out.write("					let deleteURL = \"rboardDelete.lhd\";\r\n");
      out.write("					let method = \"POST\";\r\n");
      out.write("					let dataParam = {\r\n");
      out.write("							rkbnum: $('#rbnum').val(rbnumV),\r\n");
      out.write("					};\r\n");
      ...
      out.write("				console.log(\">>> SALL In\");\r\n");
      out.write("				\r\n");
      out.write("				let selectALLURL = \"rboardSelectAll.lhd\";\r\n");
      out.write("				let method = \"POST\";\r\n");
      out.write("				let dataParam = {\r\n");
      ...
      out.write("				function whenSuccess(resData) {\r\n");
      out.write("					console.log(\">>> resData : \" + resData);\r\n");
      out.write("					//output >>> resData : RB0001,111,test01,2023-06-02 15:12:56&\r\n");
      out.write("\r\n");
      out.write("					\r\n");
      ...
      out.write("					console.log(\">>> v.length : \" + v.length);\r\n");
      out.write("					let sLen = v.length;\r\n");
      out.write("					console.log(\">>> sLen : \" + sLen);\r\n");
      out.write("					console.log(\">>> v[sLen] : \" + v[sLen]);\r\n");
      out.write("					console.log(\">>> typeof(v[sLen]) : \" + typeof(v[sLen]));\r\n");
      out.write("					for(let i=0; i< v.length; i++) {\r\n");
      out.write("						console.log(\">>>> v[i] : \" + v[i]);\r\n");
      out.write("						let vv = v[i].split(\",\");\r\n");
      out.write("						let j=0;\r\n");
      out.write("						for(; j < vv.length; j++) {\r\n");
 ...
 request.setCharacterEncoding("UTF-8"); 
      ...
      out.print(bnum);
      out.write("\">\r\n");
      out.write("							<input type=\"hidden\" name=\"rbnum\" id=\"rbnum\">\r\n");
      ...
      out.write("						<td>\r\n");
      out.write("							<textarea name=\"rbcontent\" id=\"rkbcontent\" rows=\"5\" cols=\"50\" style=\"resize: none\"></textarea>	\r\n");
